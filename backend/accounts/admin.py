...
admin.site.site_header = "GoldenLeaf Travels Administration"
admin.site.site_title = "GoldenLeaf Travels Admin Portal"
admin.site.index_title = "Welcome to GoldenLeaf Travels Admin Dashboard"
