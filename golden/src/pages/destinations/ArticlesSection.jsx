    ...
    <>
      ...
      <section className="glance-section">
        ...
        <div className="glance-grid">
          ...
          <div><h4>POPULATION</h4><p>{glanceData.population || "-"}</p></div>
          ...
          <div><h4>CALLINGCODE</h4><p>{glanceData.calling_code || glanceData.callingCode || "-"}</p></div>
      ...
      <section className="learn-section">
        ...
        {topics.map(({ title, topic, description, image_url, image }, i) => {
          ...
          return (
            <div
              key={heading + i}
              className={`learn-block ${i % 2 ? "img-left" : "img-right"}`}
            >
              {i % 2 ? (
                <>
